...
The project demonstrates an IoT-based RFID monitoring system that combines embedded hardware with AWS cloud services.
...
본 프로젝트를 통해 ESP8266 기반 RFID 장치와 AWS EC2 웹 서비스를 연동하는 기본적인 IoT 시스템을 구현하였습니다.

향후 데이터베이스와 REST API를 추가하여 실시간 출입 관리 시스템으로 확장할 수 있습니다.

---

# License

This project was created for AWS IoT Workshop and educational purposes.
